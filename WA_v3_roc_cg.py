...
from utils.tdmi import compute_delay_matrix, compute_snr_matrix, compute_noise_matrix
...
if __name__ == '__main__':
    ...
    tdmi_mask_total = {}
    with open(path + 'WA_v3_roc_cg.md', 'w') as ofile:
        ...
        for weight_mask, idx in zip(
            ...
            plt.tight_layout()
            plt.savefig(path + f'WA_v3_roc_{idx:d}_cg.png')
            plt.close()
        
        np.save(path + 'roc_WA_v3_roc_cg.npy', roc_data)
    with open(path + 'WA_v3_roc_cg.pkl', 'wb') as f:
