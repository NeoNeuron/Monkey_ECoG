...
if __name__ == '__main__':
    from ch_bin_recon_gc import gen_bin_recon
    ...
    ifnames = ['th_fit_gc_CG.pkl', 'th_roc_gc_CG.pkl', 'th_gap_gc_CG.pkl']
    ofnames = ['recon_fit_gc_CG.pkl', 'recon_roc_gc_CG.pkl', 'recon_gap_gc_CG.pkl']
