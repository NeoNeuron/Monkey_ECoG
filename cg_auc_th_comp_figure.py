...
if __name__ == '__main__':
    ...
    with open(args.path + 'cg_aucs.pkl', 'rb') as f:
        aucs_tdmi = pickle.load(f)
    with open(args.path + 'cg_aucs_gc_order_6.pkl', 'rb') as f:
    ...
    fig.get_axes()[0].set_ylim(0.45,0.9)

    fname = f'auc-threshold_summary_cg.png'
